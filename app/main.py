...
def read_cleaned_data():
    data = pd.read_csv(r"C:\Users\MD Rasel Mia\OneDrive\Desktop\archive\data\data.csv")
...
def add_prediction(input_data):
    model = pickle.load(open(r"C:\Users\MD Rasel Mia\OneDrive\Desktop\archive\model\model.pkl", 'rb'))
    scaler = pickle.load(open(r"C:\Users\MD Rasel Mia\OneDrive\Desktop\archive\model\scaler.pkl", 'rb'))
...
def main():
    ...
    with open(r"C:\Users\MD Rasel Mia\OneDrive\Desktop\archive\Assets\style.css") as f:
